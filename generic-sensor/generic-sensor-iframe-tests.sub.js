...
function run_generic_sensor_iframe_tests(sensorName, featurePolicies) {
  ...
  sensor_test(async t => {
    ...
    await send_message_to_iframe(iframe, {command: 'create',
                                          type: sensorName});
    ...
    await send_message_to_iframe(iframe, {command: 'start'});
    ...
    await send_message_to_iframe(iframe, {command: 'is_suspended'}, true);
 ...
 to cross-origin frame`);
  ...
  sensor_test(async t => {
    ...
    await send_message_to_iframe(iframe, {command: 'is_suspended'}, false);
